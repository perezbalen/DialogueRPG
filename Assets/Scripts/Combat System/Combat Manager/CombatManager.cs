...
public class CombatManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Checks if it must call the orgasm cards, or the frustration cards, etc.
    /// and calls them.
    /// </summary>
    public void CheckForSomethingImportant ()
    {
        Player1.CheckHPStatusForImportantUpdates();
        Player2.CheckHPStatusForImportantUpdates();
    }
